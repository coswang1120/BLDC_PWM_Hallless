...
void ADC1_Configuration(void)
{
    ...
    //常规转换序列2：通道1   
    ADC_RegularChannelConfig(ADC1, ADC_Channel_1, 2, ADC_SampleTime_7Cycles5);    //PA1
    //常规转换序列1：通道2
    ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 3, ADC_SampleTime_7Cycles5);    //PA2
    //常规转换序列2：通道3   
    ADC_RegularChannelConfig(ADC1, ADC_Channel_3, 4, ADC_SampleTime_7Cycles5);    //PA3
    //常规转换序列2：通道8  
