...
void InitThree_BEF_Gpio(void ) 
{
  ...
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB|RCC_APB2Periph_AFIO, ENABLE);  // open reet clock
	GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable,ENABLE);   // lose JTAG ability 
